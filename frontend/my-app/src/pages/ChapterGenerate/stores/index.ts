...
export function useDataSlice(): DataSlice {
  return useChapterGenerateStore((state) => ({
    ...
    saveShotRevisions: state.saveShotRevisions,
    shotTreatmentDrafts: state.shotTreatmentDrafts,
    shotServerHeads: state.shotServerHeads,
    shotEventIdentities: state.shotEventIdentities,
    setShotTreatmentDraft: state.setShotTreatmentDraft,
