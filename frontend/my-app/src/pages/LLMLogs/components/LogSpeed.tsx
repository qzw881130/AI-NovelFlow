  ...
  return (
    <>
      <button
        ...
        className="inline-flex min-h-[44px] min-w-[44px] items-center gap-1.5 whitespace-nowrap rounded px-1 text-left tabular-nums hover:text-primary-700 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary-500"
      >
      ...
      {open && createPortal(
        <div
          ...
          onPointerLeave={scheduleClose}
          style={position}
          className="fixed z-[100] w-80 max-w-[calc(100vw-16px)] max-h-[calc(100dvh-16px)] overflow-y-auto whitespace-normal rounded-lg border border-gray-200 bg-white p-4 text-sm text-gray-700 shadow-lg"
        >
