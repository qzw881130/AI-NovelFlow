...
export default {
  tasks: {
    ...
    failed: '실패',
    error: '오류',
    comfyuiHint: 'ComfyUI 작업에 문제가 있으면 Clip 상태를 확인하고 누락된 Clip을 다시 생성하세요.',
    cancelled: '취소됨',
    completedAt: '완료 시간',
    noTasksCreated: '작업이 생성되지 않았습니다',
    noTasksInStatus: '현재 필터와 일치하는 작업이 없습니다',
    terminateAll: '전체 종료',
    ...
    queueTasks: '큐 작업',
    taskList: '작업 목록',
    multiClipDetails: 'Multi-Clip 상세',
    clipCount: '{count}개 Clip',
    dialogueCount: '대사 {count}',
    promptId: 'prompt_id: {id}',
    viewClipWorkflow: 'Clip 실제 워크플로우 보기',
    viewClipVideo: 'Clip 비디오 보기',
    clipStatuses: {
      pending: '대기 중',
      promptBuilding: 'H3 프롬프트 생성 중',
      queued: '생성 중',
      running: '실행 중',
      succeeded: '완료됨',
      failed: '실패',
    ...
    types: {
      ...
      characterVoice: '캐릭터 음색',
      audioEventTts: 'Audio Event TTS',
      audioPrepare: 'AudioDrive 오디오 준비',
      characterAudio: '캐릭터 오디오',
      narratorAudio: '내레이터 오디오',
      sceneImage: '장면 이미지',
      shotImage: '샷 이미지',
      shotImageBatch: '샷 이미지 일괄 생성',
      keyframeImage: '키프레임 이미지',
      singleImageEdit: '단일 이미지 편집',
      shotVideo: '샷 비디오',
      shotVideoBatch: '샷 비디오 일괄 생성',
      chapterVideo: '챕터 비디오',
    ...
    workflowNames: {
      ...
      '系统默认-分镜生视频': '시스템 기본-단일 프레임 비디오',
      '系统默认-单帧生视频': '시스템 기본-단일 프레임 비디오',
      ...
      'Flux2-Klein-9B 关键帧生图': 'Flux2-Klein-9B 키프레임 이미지',
    ...
    workflowDescriptions: {
      ...
      'Flux2-Klein-9B 关键帧生图工作流，支持参考图': 'Flux2-Klein-9B 키프레임 이미지 워크플로우, 참조 이미지 지원',
