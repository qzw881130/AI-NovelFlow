...
export default {
  tasks: {
    ...
    failed: '失敗',
    error: 'エラー',
    comfyuiHint: 'ComfyUI タスク異常時は Clip 状態を確認し、不足している Clip を再生成してください。',
    cancelled: 'キャンセル済み',
    completedAt: '完了日時',
    noTasksCreated: 'タスクが作成されていません',
    noTasksInStatus: '現在のフィルターに一致するタスクはありません',
    terminateAll: '全て停止',
    ...
    queueTasks: 'キュータスク',
    taskList: 'タスクリスト',
    multiClipDetails: 'Multi-Clip 詳細',
    clipCount: '{count} Clips',
    dialogueCount: 'セリフ {count}',
    promptId: 'prompt_id: {id}',
    viewClipWorkflow: 'Clip の実際のワークフローを表示',
    viewClipVideo: 'Clip 動画を表示',
    clipStatuses: {
      pending: '保留中',
      promptBuilding: 'H3プロンプト作成中',
      queued: '動画生成中',
      running: '実行中',
      succeeded: '完了',
      failed: '失敗',
    ...
    types: {
      ...
      characterVoice: 'キャラクターボイス',
      audioEventTts: 'Audio Event TTS',
      audioPrepare: 'AudioDrive 音声準備',
      characterAudio: 'キャラクター音声',
      narratorAudio: 'ナレーター音声',
      sceneImage: 'シーン画像',
      shotImage: 'ショット画像',
      shotImageBatch: 'ショット画像一括生成',
      keyframeImage: 'キーフレーム画像',
      singleImageEdit: '単一画像編集',
      shotVideo: 'ショット動画',
      shotVideoBatch: 'ショット動画一括生成',
    ...
    workflowNames: {
      ...
      '系统默认-分镜生视频': 'システム既定-単一フレーム動画',
      '系统默认-单帧生视频': 'システム既定-単一フレーム動画',
      ...
      'Flux2-Klein-9B 关键帧生图': 'Flux2-Klein-9B キーフレーム画像',
    ...
    workflowDescriptions: {
      ...
      'Flux2-Klein-9B 关键帧生图工作流，支持参考图': 'Flux2-Klein-9B キーフレーム画像ワークフロー、参照画像対応',
