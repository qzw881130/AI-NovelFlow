...
export default {
  ...
  systemSettings: {
    ...
    workflow: {
      ...
      videoSaveNode: 'Video Output Node',
      videoSaveNodeTip: 'Select the VHS_VideoCombine or H3 AV Stream node that outputs the video',
  ...
  promptConfig: {
    ...
    templateNames: {
      ...
      '标准角色生成': 'Standard Character Generation',
    ...
    templateDescriptions: {
      ...
      '标准角色生成': 'Generate a standard character portrait using the novel visual style and character appearance',
