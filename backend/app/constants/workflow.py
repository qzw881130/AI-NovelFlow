...
DEFAULT_WORKFLOWS = {
    ...
    "video": "video_minimax_h3_audiodrive.json",
...
DEFAULT_WORKFLOW_NODE_MAPPINGS = {
    ...
    "video": {
        "prompt_node_id": "51",
        "video_save_node_id": "95",
        "max_side_node_id": None,
        "megapixels_node_id": "96",
        "megapixels_value": "0.4",
        "reference_image_node_id": "45",
        "frame_count_node_id": None,
        "reference_audio_node_id": None,
        "drive_audio_node_id": "61",
        "final_audio_node_id": "91",
        "duration_seconds_node_id": "48",
    },
    "keyframe_image": {
        # 提示词节点
        "prompt_node_id": "110",
    ...
    "first_last_video": {
        "prompt_node_id": "51",
        "first_image_node_id": "45",
        "last_image_node_id": "97",
        "video_save_node_id": "95",
        "megapixels_node_id": "96",
        "megapixels_value": "0.4",
        "frame_count_node_id": None,
...
EXTRA_SYSTEM_WORKFLOWS = [
    ...
    {
        "filename": "video_minimax_h3_audiodrive.json",
        "type": "video",
        "name": "MiniMax H3 AudioDrive 单帧生视频",
        "nameKey": f"{NAME_KEY_PREFIX}.MiniMax H3 AudioDrive 单帧生视频",
        "description": "MiniMax H3 AudioDrive 单帧视频工作流，使用 drive/final 双音轨",
        "descriptionKey": f"{DESC_KEY_PREFIX}.MiniMax H3 AudioDrive 单帧视频工作流，使用 drive/final 双音轨",
        "node_mapping": DEFAULT_WORKFLOW_NODE_MAPPINGS["video"],
        "extension": {"max_clip_duration": 15, "frame_count": 1},
    },
    {
        "filename": "first_last_video_minimax_h3_audiodrive.json",
        "type": "first_last_video",
        "name": "MiniMax H3 AudioDrive 首尾帧生视频",
        "nameKey": f"{NAME_KEY_PREFIX}.MiniMax H3 AudioDrive 首尾帧生视频",
        "description": "MiniMax H3 AudioDrive 首尾帧视频工作流，使用 START/END 两张图和 drive/final 双音轨",
        "descriptionKey": f"{DESC_KEY_PREFIX}.MiniMax H3 AudioDrive 首尾帧视频工作流，使用 START/END 两张图和 drive/final 双音轨",
        "node_mapping": DEFAULT_WORKFLOW_NODE_MAPPINGS["first_last_video"],
        "extension": {"max_clip_duration": 15, "frame_count": 2},
    },
    {
        "filename": "three_frame_video_minimax_h3_audiodrive.json",
        "type": "three_frame_video",
        "name": "MiniMax H3 AudioDrive 三帧生视频",
        "nameKey": f"{NAME_KEY_PREFIX}.MiniMax H3 AudioDrive 三帧生视频",
        "description": "MiniMax H3 AudioDrive 三帧视频工作流，使用 3 张关键帧图和 drive/final 双音轨",
        "descriptionKey": f"{DESC_KEY_PREFIX}.MiniMax H3 AudioDrive 三帧视频工作流，使用 3 张关键帧图和 drive/final 双音轨",
        "node_mapping": DEFAULT_WORKFLOW_NODE_MAPPINGS["three_frame_video"],
        "extension": {"max_clip_duration": 15, "frame_count": 3},
    },
    {
        "filename": "four_frame_video_minimax_h3_audiodrive.json",
        "type": "four_frame_video",
        "name": "MiniMax H3 AudioDrive 四帧生视频",
        "nameKey": f"{NAME_KEY_PREFIX}.MiniMax H3 AudioDrive 四帧生视频",
        "description": "MiniMax H3 AudioDrive 四帧视频工作流，使用 4 张关键帧图和 drive/final 双音轨",
        "descriptionKey": f"{DESC_KEY_PREFIX}.MiniMax H3 AudioDrive 四帧视频工作流，使用 4 张关键帧图和 drive/final 双音轨",
